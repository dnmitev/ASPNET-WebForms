...
namespace Error_Handler_Control
{
    ...
    public partial class ErrorSuccessNotifier : System.Web.UI.UserControl
    {
        ...
        public static bool ShowAfterRedirect
        {
            get
            {
                object showAfterRedirect = HttpContext.Current.Session[KEY_SHOW_AFTER_REDIRECT];
        ...
        private void IncludeTheCssAndJavaScript()
        {
            ...
            string jqueryURL = this.TemplateSourceDirectory + "/Scripts/jquery-1.3.2.js";
            ...
            string cssRelativeURL = this.TemplateSourceDirectory + "/Styles/ErrorSuccessNotifier.css";
